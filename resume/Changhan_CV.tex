...
% ======================= Header =======================================
{\huge\bfseries Chang-Han Chen}\hfill{\small\color{gray}Last update: September 2026}
...
Many challenges in AI, across both capability and safety, are actually about generalization. Think about
solving scientific problems beyond human ability, or alignment in unfamiliar situations where reward seems
almost impossible.

\vspace{4pt}
I aim to improve \textbf{data efficiency and generalization} through (1) architectures that use denser
computation to reason more effectively, and (2) training algorithms that continue to improve learning from
fixed data or rollouts as compute increases. My interests include architectural and optimization changes
that enable deeper computation, such as skip connections and preconditioning; diffusion training curricula;
ensembling; and stable reinforcement learning for transformers that reason in latent space.

\vspace{4pt}
For more on how I think about these questions, see \href{https://chang-han-chen.github.io/blog/a-new-chapter/}{this blog}.

% ======================= Selected Projects ============================
\section{Selected Projects}
\begin{itemize}
  \item \entry{\href{https://github.com/Chang-Han-Chen/autoresearch-moe}{\textcolor{black}{MoE autoresearch}}}{2026}\\
  ...
  \item \entry{\href{https://arxiv.org/abs/2406.02116}{\textcolor{black}{A clock is just a way to tell the time}}\ \normalfont(with G.\ Penington)}{2024 Spring}\\
        Applied von Neumann algebra tools to cosmology, clearing up common misconceptions; widely cited in the field.
...
\section{Skills}
\begin{itemize}
  \item \textbf{Programming:} Python, PyTorch, JAX, Megatron-LM, SGLang, SkyRL.
